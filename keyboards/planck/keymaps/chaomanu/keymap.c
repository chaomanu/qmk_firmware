...
#define FNLEFT MO(_FNLEFT)
#define FNRGHT MO(_FNRGHT)
...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, FNLEFT,  KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,  KC_LEFT,  KC_RGHT, FNRGHT,   KC_MPLY
),
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    TGNUM,   _______,   _______, _______, _______, _______, KC_DOT,  KC_0,   KC_COMM, KC_COMM, _______, _______
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_AT,   KC_AMPR, KC_COLN, KC_SLSH, _______, KC_PMNS, KC_QUOT,   KC_LPRN, KC_RPRN, KC_ASTR, _______, 
    _______, KC_HASH, KC_PERC, KC_PIPE, KC_BSLS, _______, KC_PPLS, S(KC_QUOT),KC_LEFT, KC_RGHT, KC_UP,   KC_DOWN,
    _______, _______, _______, _______, _______, _______, _______, _______,   KC_UP,   KC_DOWN, _______, _______
),
...
[_NUM] = LAYOUT_planck_grid(
    ...
    TGNUM,   KC_NO,    KC_NO,   _______, KC_NO,   _______, KC_DOT,   KC_KP_0, KC_NO,     KC_COMM, KC_COMM, KC_NO
),
 ...
 * `-----------------------------------------------------------------------------------'
*/
[_FNLEFT] = LAYOUT_planck_grid(
	_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, _______, _______, _______, _______, _______,
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, KC_LEFT, KC_RGHT, _______, _______, _______,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_UP,   KC_DOWN, _______, _______, _______,
