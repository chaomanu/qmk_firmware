...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_HASH,   KC_PERC, _______, _______, _______, KC_PPLS, KC_1,  KC_2,    KC_3,    KC_PSLS,  KC_MINS,
    TGNUM,   _______,   _______, _______, _______, _______, KC_EQL,  KC_0,  KC_DOT,  KC_COMM, _______,  _______
),
...
/* 'NUM'
 * ,-----------------------------------------------------------------------------------.
 * |  ESC |  No  |  No  |   ;  |  No  |  No  |  No  |   7  |   8  |   9  |  No  | Bksp |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | CALC |   €  |   $  |   :  |  No  |  No  |   -  |   4  |   5  |   6  |   *  | Enter|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   #  |   %  |  No  |  No  |  No  |   +  |   1  |   2  |   3  |   /  |  No  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |TGNUM |  No  |  No  | Alt  |  No  |      =      |   0  |  .   |  ,   |  No  |  No  |
 * `-----------------------------------------------------------------------------------'
*/
[_NUM] = LAYOUT_planck_grid(
    ...
    _______, KC_HASH,  KC_PERC, KC_NO,   KC_NO,   KC_NO,   KC_PPLS,  KC_KP_1, KC_KP_2,  KC_KP_3, KC_PSLS, KC_NO,
    TGNUM,   KC_NO,    KC_NO,   _______, KC_NO,   _______, KC_EQL,   KC_KP_0, KC_DOT,   KC_COMM, KC_NO,   KC_NO
),
