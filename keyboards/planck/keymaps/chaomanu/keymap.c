...
[_RAISE] = LAYOUT_planck_grid(
    KC_DEL,  KC_EXLM, KC_CIRC, KC_SCLN, KC_TILD, KC_GRV,  KC_QUOT, KC_DQT,  KC_LBRC, KC_RBRC, KC_QUES, _______,
    _______, KC_AT,   KC_AMPR, KC_COLN, KC_SLSH, _______, KC_PMNS, KC_EQL,  KC_LPRN, KC_RPRN, KC_ASTR, _______, 
    _______, KC_HASH, KC_PERC, KC_PIPE, KC_BSLS, _______, KC_PPLS, KC_UNDS, KC_LEFT, KC_RGHT, KC_UP,   KC_DOWN,
...
[_FNLEFT] = LAYOUT_planck_grid(
    ...
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, KC_LEFT, KC_RGHT, KC_UP  , KC_DOWN,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
...
[_FNRGHT] = LAYOUT_planck_grid(
    ...
    _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, _______, _______, _______, _______, _______,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_MUTE, _______, KC_VOLU, KC_VOLD, _______,
